...
public class AddCollectionHandler : IRequestHandler<CreateCollectionCommand>
{
    private readonly IUnitOfWork unitOfWork;
    private readonly IMapper mapper;
    private readonly IFileStorageService fileStorageService;

    public AddCollectionHandler(IMapper mapper, IUnitOfWork unitOfWork, IFileStorageService fileStorageService)
    {
        this.mapper = mapper;
